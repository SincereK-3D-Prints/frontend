...
_FooterComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["shop-footer"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 1, consts: [[1, "surface-section", "px-4", "py-6", "md:px-6", "lg:px-4", "text-center"], [1, "font-medium", "text-900", "mt-4", "mb-3"]], template: function FooterComponent_Template(rf, ctx) {
  if (rf & 1) {
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-TVAMI5UP.mjs.map
