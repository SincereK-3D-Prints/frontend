...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-JA7W3Y2X.js");
...
// src/routes.ts
var routes = [
  { path: "", loadComponent: () => import("./chunk-KAZUQJUR.js").then((x) => x.ComingSoonView) },
  { path: "coming-soon", loadComponent: () => import("./chunk-KAZUQJUR.js").then((x) => x.ComingSoonView) },
  { path: "home", loadComponent: () => import("./chunk-2M52UDWT.js").then((x) => x.HomeView) },
  { path: "test", loadComponent: () => import("./chunk-J6QCOAZN.js").then((x) => x.TestView) },
  { path: "product", loadComponent: () => import("./chunk-NPC2K37W.js").then((x) => x.ProductView) }
];
...
// src/main.ts
bootstrapApplication(AppComponent, mainConfig).catch((err) => console.error(err));
